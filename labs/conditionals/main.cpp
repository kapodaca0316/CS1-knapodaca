...
void test() {
    ...
    assert(findDifference(3, 37.2) == -34.2);
    assert(findDifference(73, 59) == 14);
    assert(findProduct(6, 9) == 54);
    assert(findProduct(-2, 8) == -16);
    assert(findLarger(28, 57) == 57);
    assert(findLarger(-7, 10) == 10);
    assert(findSmaller(-2, -6) == -6);
